...
(function($){
    ...
    return this.each(function() {
			...
			$(window).resize(function(e){
				...
				var availablewidth = (divwidth - $('> .previous_cine', divobj).outerWidth(true) - $('> .next_cine', divobj).outerWidth(true));
				...
				if (visiblelis >= totallis || ((divwidth >= (totallis * liwidth)) && options.hidearrows) ) {
					if (options.hidearrows) {
						$('> .previous_cine', divobj).hide();
						$('> .next_cine', divobj).hide();
			...
			$('> .previous_cine', divobj).click(function(){
			...
			$('> .next_cine', divobj).dblclick(function(e){
				e.preventDefault();
				clearSelection();
			});

			$('> .previous_cine', divobj).dblclick(function(e){
				e.preventDefault();
				clearSelection();
			});
