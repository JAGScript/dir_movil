...
<div class="row">
	<div class="col-md-12" style="text-align:center;">
		<h2><span class="label label-primary">Nuevo Mapa</span></h2>
	</div>
</div>
<div class="row" style="margin-top:15px;">
	<div class="col-md-12" style="text-align:right;">
		<button class="btn btn-primary" type="button" onclick="window.location='?modulo=map_lista';">
...
<script>$(function(){
	...
	new AjaxUpload(btnUpload, {
		action: 'subpages/sistema/mapas/ajax/upload.php',
		name: 'uploadfile',
		...
		onComplete: function(file, response){
			...
			document.getElementById('imagen_subida').src='subpages/mapas/'+mirsp;
			$('#btnborrarimg').fadeIn();
		}
	});
});
...
function guardar(){
	...
	if((imagen == '') || (fechainicio == '') || (fechafin == '') || (nombre == '') || (descripcion == '')){
		...
		$.post('subpages/sistema/mapas/ajax/guardar.php',{
			imagen : imagen, fechainicio : fechainicio, fechafin : fechafin, nombre : nombre, descripcion : descripcion
