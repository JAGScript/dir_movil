<?php 
	...
	$select = "SELECT * FROM anuncios";
	$stmt = $gbd -> prepare($select);
	$stmt -> execute();
?>
<div class="row">
	<div class="col-md-12" style="text-align:center;">
		<h2><span class="label label-warning">Anuncios</span></h2>
	</div>
</div>
<div class="row" style="margin-top:15px;">
	<div class="col-md-12" style="text-align:right;">
		<button class="btn btn-primary" type="button" onclick="window.location='?modulo=anu_nuevo';">
			...
			<table class="table table-hover">
				...
				while($row = $stmt -> fetch(PDO::FETCH_ASSOC)){
					...
					<tr style="text-align:center;">
						...
						<td><img src="subpages/anuncios/'.$row['img'].'" style="max-width:100px;"/></td>
