...
<div class="row">
	<div class="col-md-12" style="text-align:center;">
		<h2><span class="label label-primary">Nueva Categoría</span></h2>
	</div>
</div>
<div class="row" style="margin-top:15px;">
	<div class="col-md-12" style="text-align:right;">
		<button class="btn btn-primary" type="button" onclick="window.location='?modulo=cat_lista';">
...
<div class="row" style="margin-top:15px;">
	<div class="col-md-6 col-md-push-3">
		<h4><strong>Nombre de la Categoría:</strong></h4>
		<input type="text" class="form-control mayus" id="nombre" placeholder="Ingrese nombre de la categoría..." />
	</div>
</div>
<div class="row" style="margin-top:15px;">
...
<script>$(function(){
	...
	new AjaxUpload(btnUpload, {
		action: 'subpages/sistema/categorias/ajax/upload.php',
		name: 'uploadfile',
		...
		onComplete: function(file, response){
			...
			document.getElementById('imagen_subida').src='subpages/categorias/'+mirsp;
			$('#btnborrarimg').fadeIn();
		}
	});
});
...
function guardar(){
	...
	if((nombre == '') || (imagen == '')){
		...
		$.post('subpages/sistema/categorias/ajax/guardar.php',{
