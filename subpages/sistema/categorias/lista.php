<?php 
	...
	$select = "SELECT * FROM categoria ORDER BY nombre ASC";
	$stmt = $gbd -> prepare($select);
	$stmt -> execute();
?>
<div class="row">
	<div class="col-md-12" style="text-align:center;">
		<h2><span class="label label-warning">Lista de Categorías</span></h2>
	</div>
</div>
<div class="row" style="margin-top:15px;">
	<div class="col-md-12" style="text-align:right;">
		<button class="btn btn-primary" type="button" onclick="window.location='?modulo=cat_nuevo';">
			...
			<table class="table table-hover">
				...
				while($row = $stmt -> fetch(PDO::FETCH_ASSOC)){
					...
					<tr style="text-align:center;">
						...
						<td><img src="subpages/categorias/'.$row['img'].'" style="max-width:100px;"/></td>
