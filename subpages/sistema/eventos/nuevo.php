...
<div class="row" style="margin-top:15px;">
	<div class="col-md-12" style="text-align:right;">
		<button class="btn btn-primary" type="button" onclick="window.location='?modulo=eve_lista';">
...
<div class="row" style="margin-top:15px;">
	<div class="col-md-6 col-md-push-3">
		<div class="row">
			<div class="col-md-12">
				<h4><strong>Nombre del Evento:</strong></h4>
				<input type="text" class="form-control mayus" id="nombre" placeholder="Ingrese el nombre del evento..." />
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-md-6 col-md-push-3">
		<div class="row">
			<div class="col-md-12">
				...
				<textarea class="form-control mayus" rows="3" maxlength="500" id="descripcion" placeholder="Ingrese la descripción del evento..."></textarea>
			</div>
		</div>
	</div>
</div>
...
<div class="row" style="margin-top:15px;">
	<div class="col-md-6 col-md-push-3">
		<div class="row">
			<div class="col-md-12">
				<h4><strong>Nombre del Video:</strong></h4>
				<input type="text" class="form-control mayus" id="video" placeholder="Ingrese el nombre del video..." />
			</div>
		</div>
	</div>
</div>
...
$(function(){
	...
	new AjaxUpload(btnUpload, {
		action: 'subpages/sistema/eventos/ajax/upload.php',
		name: 'uploadfile',
		...
		onComplete: function(file, response){
			...
			document.getElementById('imagen_subida').src='subpages/eventos/'+mirsp;
			$('#btnborrarimg').fadeIn();
		}
	});
});
...
function guardar(){
	...
	var video = $('#video').val();
	if((imagen == '') || (fechainicio == '') || (fechafin == '') || (nombre == '') || (descripcion == '')){
		$('#vacio').modal('show');
	}else{
		$('#btn_guardar').fadeOut('slow');
		$('#wait').delay(600).fadeIn('slow');
		$.post('subpages/sistema/eventos/ajax/guardar.php',{
			imagen : imagen, fechainicio : fechainicio, fechafin : fechafin, nombre : nombre, descripcion : descripcion, video : video
