...
<div class="row">
	<div class="col-md-12">
		<div class="well" style="text-align:center;">
			<h4>
				<strong>Locales de la categoría "<span id="nom_local"><?php echo $categoria_nombre;?></span>"</strong>
		...
		<div class="col-sm-6 col-md-4">
			<div class="thumbnail" style="background-color:transparent;">
				...
				<div class="caption">
					...
					<p>
						<a class="btn btn-warning" onclick="ruta('.$row['local_id'].')" role="button">
							¿Cómo llegar?
							<span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
						</a> 
						<a onclick="saber_mas('.$row['local_id'].')" class="btn btn-primary" role="button">
							Info!
...
$(document).ready(function(){
	...
	var img = $('#nom_local').html();
	if(img == 'BELLEZA'){
		$('#emo_logo').prop('src','img/emo_labial_230118.gif');
		$('#emo_logo').prop('title','Estos locales te haran sentir una modelo!');
	}
