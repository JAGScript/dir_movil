<?php 
	...
	$select = "SELECT * FROM local WHERE nombre LIKE '$letra%' GROUP BY nombre ORDER BY nombre ASC";
...
<div class="row">
	<div class="col-md-12">
		<div class="well" style="text-align:center;">
			<h4>
				<strong>Locales con la letra "<?php echo $letra;?>"</strong>
...
function buscarlocal(letra){
	window.location = '?modulo=loc_orden&data='+letra;
}
