...
<div class="row">
	<div class="col-md-12" style="text-align:center;">
		<h2><span class="label label-warning">Lista de Locales</span></h2>
	</div>
</div>
<div class="row" style="margin-top:15px;">
	<div class="col-md-12" style="text-align:right;">
		<button class="btn btn-primary" type="button" onclick="window.location='?modulo=loc_nuevo';">
			...
			<table class="table table-hover">
				...
				while($row = $stmt -> fetch(PDO::FETCH_ASSOC)){
					...
					<tr style="text-align:center;">
						...
						<td style="vertical-align:middle;">'.$row['numero'].'</td>
						<td style="background-color:#ccc;"><img src="subpages/local/'.$row['logo'].'" style="max-width:100px;"/></td>
...
function editar(data){
    window.location = '?modulo=loc_editar&data='+data;
}
</script>